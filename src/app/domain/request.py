...
class EventRequest(Request):
    ...
    def __str__(self) -> str:
        return f"Request from user {self.from_user_id} to accept or reject creation of event {self.event_id} on workspace {self.workspace_id}"
...
class WorkspaceRequest(Request):
    ...
    def __str__(self) -> str:
        return f"Request from user {self.from_user_id} to accept or reject changetype of workspace {self.workspace_id}"
